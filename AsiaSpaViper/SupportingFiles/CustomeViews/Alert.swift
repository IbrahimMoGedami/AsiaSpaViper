...
class Alert: UIViewController{
    ...
    class func miAlert(msg:String) -> MIAlertController {
        ...
        googlishAlertControllerConfig.messageLabelTextColor = UIColor(red: 5, green: 174, blue: 185, alpha: 1)
    ...
    class func showAlert(target: UIViewController, title: String, message: String, okAction: String, actionCompletion: ((UIAlertAction) -> Void)?) {
        ...
        let titleFont: UIFont = UIFont(name: "Droid Sans-Regular", size: 15) ?? UIFont()
        let messageFont: UIFont = UIFont(name: "Droid Sans-Regular", size: 19) ?? UIFont()
